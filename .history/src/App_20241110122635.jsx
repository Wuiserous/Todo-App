...
function App() {
  ...
  return (
    <div className='w-[100vw] overflow-hidden p-2 gap-2 h-[100vh] grid grid-cols-[50px_1100px_60px_1fr] grid-rows-[50px_1fr_1fr_1fr]'>
      ...
      <NavBar Button={<button className="w-10 h-10 rounded-full flex items-center justify-center" onClick={() => setDarkMode(!darkMode)}>{darkMode ? <MdWbSunny size={25} /> : <IoMoonOutline />}</button>} bgColor={darkMode?'bg-gray-800' : 'bg-gray-100' }/>
