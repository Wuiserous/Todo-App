...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid_cols_10 grid-rows-10'>
      <div className='bg-orange-500 rounded-xl col-start-1 col-span-1 row-start-2 row-span-10'></div>
      ...
      <div className='rounded-xl col-span-1 row-span-10 bg-green-500'></div> 
