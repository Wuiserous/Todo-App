...
function App() {
  ...
  return (
    <div className={`w-[100vw] overflow-hidden p-2 gap-2 h-[100vh] grid grid-cols-[50px_1100px] grid-rows-[50px_1fr_1fr_1fr]`}>
      ...
      {isExpanded ? null : <ProgressSpace bgColor={darkMode ? 'bg-slate-300' : 'bg-[#121212]'} />}
      {isExpanded ? null : <MotivationSpace bgColor={darkMode ? 'bg-slate-300' : 'bg-[#121212]'} />}
