...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid_cols_[50px_1fr_1fr_1fr]'>
      <div className='bg-orange-500 rounded-xl col-span-1 row-start-1 row-span-10'></div>
