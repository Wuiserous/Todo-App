...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-[50px_50px_50px_50px_50px_50px_50px_50px_50px_50px_50px_50px] grid-rows-[50px_50px_50px_50px]'>
      <div className='bg-orange-500 rounded-xl col-start-1 col-end-1 row-start-1 row-end-10'></div>
      <div className='rounded-xl col-start-2 col-end-15 bg-blue-500 2'></div>
