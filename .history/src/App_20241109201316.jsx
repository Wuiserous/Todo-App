...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-[50px_1fr_1fr_1fr] grid-rows-[1fr_1fr_1fr_1fr_1fr_1fr]'>
      <div className='bg-orange-500 rounded-xl col-span-1 row-span-9'></div>
