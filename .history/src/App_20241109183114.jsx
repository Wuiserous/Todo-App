...
function App() {
  return (
    <div className='w-screen h-screen grid grid-cols-4 grid-rows-2'>
      ...
      <div className='col-span-2 row-span-1 bg-yellow-500'></div>
      <div className='col-span-1 row-span-1 bg-green-500'></div>
      <div className='col-span-2 row-span-1 bg-green-500'></div>
    </div>
  )
}
