...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-[50px_50px_50px_50px50px_50px_50px_50px] grid-rows-[50px_50px_50px_50px]'>
      <div className='bg-orange-500 rounded-xl col-span-1 row-span-10'></div>
      <div className='rounded-xl col-span-2 bg-blue-500 2'></div>
