...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-[50px_50px_50px_50px_50px_50px_50px_50px] grid-rows-[50px_50px_50px_50px]'>
      ...
      <div className='rounded-xl col-start-2 col-end-8=9 bg-blue-500 2'></div>
      <div className='rounded-xl col-start-2 col-end-9 bg-yellow-500 3'></div>
      <div className='  rounded-xl col-span-1 bg-green-500 4'></div>
