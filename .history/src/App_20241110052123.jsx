...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-[50px_1fr_50px_1fr] grid-rows-[50px_1fr_1fr_1fr]'>
      ...
      <div className='rounded-xl col-start-2 row-starrt- col-span-2 bg-yellow-500 3'></div>
      <div className='rounded-xl col-span-1 bg-green-500'></div> 
      <div className='rounded-xl col-start-4 col-span-3 bg-red-500'></div>
    </div>
  )
}
