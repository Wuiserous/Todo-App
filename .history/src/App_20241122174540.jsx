...
function App() {
  ...
  return (
    <div className={`w-[100vw] overflow-hidden p-2 gap-2 h-[100vh] grid grid-cols-[50px_1100px_60px_1fr] ${isExpanded? 'grid-cols-[50px_1100px_60px_1fr]':'grid-cols-[50px_1100px]'} grid-rows-[50px_1fr_1fr_1fr]`}>
