...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid-cols-10 grid-rows-10'>
      <div className='bg-orange-500 rounded-xl row-span-10'></div>
      <div className='col-span-9 row-span-1 rounded-xl bg-blue-500'></div>
      <div className='col-span-6 row-span-9 rounded-xl bg-yellow-500'></div>
