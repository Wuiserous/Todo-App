...
function App() {
  return (
    <div className='w-screen p-2 gap-2 h-screen grid grid_cols_15 grid-rows-10'>
      <div className='bg-orange-500 rounded-xl col-start-1 col-end-2 row-start-1 row-end-11'></div>
