...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 ${props.isExpanded? 'col-end-5': 'col-end-3'} transform duration hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
