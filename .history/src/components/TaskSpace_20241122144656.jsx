...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl overflow-y-scroll grid grid-cols-3 gap-2 p-2 hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 ${props.bgColor}`}>
      <button className="relative h-20 w-5 top-[40%] right-0 bg-white p-1 rounded rounded-tr-[0px] rounded-br-[0px] hover:bg-blue-500 z-10"><FaAngleRight /></button>
