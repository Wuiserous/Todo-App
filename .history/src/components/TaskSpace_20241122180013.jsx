...
export default function TaskSpace(props) {
  ...
  <div className={`rounded-xl relataiv gap-2 p-2 hide-scrollbar ${props.isExpanded? 'col-span-3': 'col-span-1'} overflow-auto col-start-2 row-start-2 row-end-5 ${props.bgColor}`}>
