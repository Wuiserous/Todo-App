...
export default function Modal(props) {
    ...
    return (
      ...
      >
        <div
          className={`relative w-[500px] top-20 left-20 h-[400px] bg-white rounded-xl grid grid-rows-[1fr_40px_40px_1fr_1fr_1fr_1fr_1fr_1fr] grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr] text-black transform transition-all duration-300 p-2 ${
