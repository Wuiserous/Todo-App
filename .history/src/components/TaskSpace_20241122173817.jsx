...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 transform transition-all duration-300 ${props.isExpanded? 'col-span-5': 'col-span-1'} hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
