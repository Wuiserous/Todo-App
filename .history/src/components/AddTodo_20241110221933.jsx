export default function AddTodo(props) {
    return (
        <>
            ...
            <textarea name="" id="" placeholder="Task here..." className="w-full h-[90px] rounded-xl border border-gray-500 p-2 focus:outline-none col-start-2 col-span-7 row-start-2"></textarea>
