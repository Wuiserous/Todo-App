export default function TaskSpace(props) {
  ...
  const cards = ['Card 1', 'Card 2', 'Card 3', 'This cyclical layout is automatically handled by the modulus operation, and the cards will be arranged as you desire, looping back to the first column after the third card.', 'Card 5', 'Card 6', 'Card 7', 'Card 8'];
