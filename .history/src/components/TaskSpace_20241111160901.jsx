export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl grid grid-cols-3 gap-4 p-2 hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 ${props.bgColor} border-gray-500`}>
      <div className="h-full flex flex-col gap-2 col-span-1 border">
