export default function AddTodo(props) {
    return (
        <>
            ...
            <textarea name="" id="" placeholder="Task here..." className=" rounded text-white resize-none overflow-auto border border-gray-500 p-2 focus:outline-none bg-[#000000] col-start-2 col-span-9 row-start-2 row-span-2"></textarea>
