    ...
    return (
        <>
            <div className="col-start-1 gap-2 col-end-11 mb-2 grid grid-cols-[1fr_1fr] grid-rows-[1fr]">
                <button className="col-start-1 hover:bg-blue-500 transform transition-all duration-1000 rounded border p-2 col-span-1" onClick={handleTask}>Task</button>
                <button className="col-start-2 hover:bg-blue-500 transform transition-all duration-1000 p-2 rounded col-span-1 border" onClick={handleTodo}>Todo-List</button>
            </div>
            ...
            {showTask && (
                <div className="grid auto-rows-auto gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
                    ...
                    <button className="rounded border-none bg-white focus:outline-none bg-black col-start-10 border col-span-1 row-start-12 row-end-13 p-2">
                        <IoIosStarOutline className="text-black" size={25} />
                    </button>
                    <button className="col-start-1 col-span-7 row-start-12 row-end-13 bg-blue-500 p-2 rounded">Add</button>
