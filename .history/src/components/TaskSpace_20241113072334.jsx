      ...
      <div className="h-full flex flex-col gap-2 col-span-1">
        {columns[0].map((card, index) => (
          <div className={`w-full relative z-1 h-fit border-[1px] ${card.isUrgent && card.isImportant ? 'border-red-600' : 
              ...
              card.isImportant ? 'border-blue-500' : ''} border-gray-500 flex flex-col gap-2 p-4 rounded-tl-xl rounded-tr-xl rounded- card-animation transition-all duration-300`} key={index}>
