export default function MotivationSpace(props) {
  ...
  const portion2 = text.slice(30, 1000)
    return (
      <div className={`rounded-xl scroll overflow-auto hide-scrollbar row-start-2 row-end-5 p-2 col-start-4 col-end-4 col-span-3 ${props.bgColor} flex items-center flex-col gap-2`}>
