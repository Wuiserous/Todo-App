export default function TaskSpace(props) {
    return (
      ...
      `}</style>
        ...
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex items-center p-2 justify-start w-full text-4xl"><strong>Title</strong></div>
          <div className="relative w-full border rounded h-2"><div className="absolute bg-blue-500 h-full rounded w-[150px]"></div></div>
          <div className=" p-2 text-left"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit possimus debitis dolorem assumenda provident, numquam sit quas minima vitae cumque est commodi, exercitationem quam dicta? Necessitatibus hic consequuntur facilis veritatis?</p></div>
        </div>
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex items-center p-2 justify-start w-full text-4xl"><strong>Title</strong></div>
          <div className="relative w-full border rounded h-2"><div className="absolute bg-blue-500 h-full rounded w-[50px]"></div></div>
          <div className=" p-2 text-left"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit possimus debitis dolorem assumenda provident, numquam sit quas minima vitae cumque est commodi, exercitationem quam dicta? Necessitatibus hic consequuntur facilis veritatis?</p></div>
        </div>
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex items-center p-2 justify-start w-full text-4xl"><strong>Title</strong></div>
          <div className="relative w-full border rounded h-2"><div className="absolute bg-blue-500 h-full rounded w-[90px]"></div></div>
          <div className=" p-2 text-left"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit possimus debitis dolorem assumenda provident, numquam sit quas minima vitae cumque est commodi, exercitationem quam dicta? Necessitatibus hic consequuntur facilis veritatis?</p></div>
        </div>
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex items-center p-2 justify-start w-full text-4xl"><strong>Title</strong></div>
        ...
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex items-center p-2 justify-start w-full text-4xl"><strong>Title</strong></div>
          <div className="relative w-full border rounded h-2"><div className="absolute bg-blue-500 h-full rounded w-[200px]"></div></div>
          <div className=" p-2 text-left"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit possimus debitis dolorem assumenda provident, numquam sit quas minima vitae cumque est commodi, exercitationem quam dicta? Necessitatibus hic consequuntur facilis veritatis?</p></div>
        </div>
      </div>
    )
