export default function TaskSpace(props) {
  ...
  const cards = ['skdf  skfsefd dkfjdfkj sldkfj slfkjoosoeaw oeafijeooeirfjjeoagir;gdlfejarogi aeoirjgaeio eoirajg er jgerkgjoeagjerigj oeajgierklgjdfgreogijagk dgjoer', 'Card 2', 'Card 3', 'Card 4', 'Card 5', 'Card 6', 'Card 7', 'Card 8'];
