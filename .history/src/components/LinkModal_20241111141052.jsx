...
export default function LinkModal(props) {
    ...
    return (
        ...
        onClick={hide}>
            <div className={`relative top-60 left-90 w-[100px] h-[100px] bg-white transform transition-all duration-100 rounded ${isVisible ? "scale-100 opacity-100" : "scale-50 opacity-0"}`}></div>
        </div>
    )
}