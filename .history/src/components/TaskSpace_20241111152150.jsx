export default function TaskSpace(props) {
    return (
      <div className={`rounded-xl flex p-2 gap-4 hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 border ${props.bgColor} border-gray-500`}>
        <div className="min-w-[200px] max-w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex flex-col items-center justify-start w-full text-4xl">
            <strong>we are in the process of building a todo-app</strong>
          </div>
          <div className="text-left h-[150px] w-fit overflow-auto hide-scrollbar">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur id molestiae ab nulla accusamus natus voluptatum repellendus! Nam asperiores corporis eum id eaque corrupti numquam ex dolorem architecto voluptates!
            ...
            Natus exercitationem repellat commodi! Ad praesentium eaque labore quam, ipsam molestiae assumenda veniam consequuntur doloremque dolorum neque, obcaecati incidunt eveniet id quaerat voluptates voluptatem quia. Officia unde soluta vel impedit.
            </p>
          </div>
        </div>
        <div className="min-w-[200px] max-w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          <div className="flex flex-col items-center justify-start w-full text-4xl">
            <strong>You need to work 24x7</strong>
          </div>
          <div className="text-left h-[150px] w-fit overflow-auto hide-scrollbar">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur id molestiae ab nulla accusamus natus voluptatum repellendus! Nam asperiores corporis eum id eaque corrupti numquam ex dolorem architecto voluptates!
            Nemo harum excepturi molestias veniam facere vero nobis explicabo. A exercitationem aperiam fugiat, dolor, quos totam mollitia beatae aut repudiandae possimus consequatur ea laboriosam doloribus hic? Ullam ut dignissimos tenetur.
