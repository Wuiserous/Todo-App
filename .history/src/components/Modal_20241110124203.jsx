...
export default function Modal(props) {
    ...
    return (
      ...
      >
        <div
          className={`relative w-[500px] top-16 left-19 h-[400px] bg-white rounded-xl flex flex-col justify-center items-center text-black transform transition-all duration-500 ${
