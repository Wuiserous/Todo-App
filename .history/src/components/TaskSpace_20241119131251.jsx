...
const sortedCards = [...cards].sort((a, b) => {
  ...
  if (priorityComparison !== 0) {
    return priorityComparison; // Lower priority number comes first
  }
  // If priorities are the same, compare by deadline seconds
  return a.deadLineSeconds - b.deadLineSeconds; // Lower deadline seconds come first
});

  // Distribute cards into the three columns
  sortedards.forEach((card, index) => {
