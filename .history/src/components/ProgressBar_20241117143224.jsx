...
export default function ProgressBar(props) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const startTime = new Date(props.createdTime);
      const deadline = new Date(`${props.deadlineDate}T${props.deadlineTime}`);
  ...
  }, [props.createdTime, props.deadlineDate, deadlineTime]);
