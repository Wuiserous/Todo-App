...
export default function AddTodo(props) {
    return (
        <>
            <div className="col-start-1 col-end-11 p-2 border grid grid-cols-[1fr_1fr] grid-rows-[1fr]"><button className="col-start-1 border col-span-1">Task</button><button className="col-start-2 col-span-1">To-do List</button></div>
