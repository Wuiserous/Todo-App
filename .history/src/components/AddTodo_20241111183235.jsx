        ...
        <>
            ...
            {showTask && (
                <div className="grid auto-rows-auto gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
                    ...
                    <button className="rounded bg-white hover:bg-red-500 border-none focus:outline-none col-start-9 col-span-1 row-start-12 row-end-13 p-2">
                        <BsExclamationTriangle className="text-black" size={25} />
                    </button>
                    <button className="rounded hover:bg-yellow-300 border-none bg-white focus:outline-none bg-black col-start-10 border col-span-1 row-start-12 row-end-13 p-2">
                        <IoIosStarOutline className="text-black" size={25} />
                    </button>
                    <button className="col-start-1 col-span-7 row-start-12 row-end-13 hover:bg-blue-700 bg-blue-500 p-2 rounded" onClick={handleSubmit}>Add</button>
                    <button className="col-start-8 hover:bg-green-500 col-span-1 row-start-12 row-end-13 bg-white p-2 rounded">
