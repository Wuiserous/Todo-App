...
export default function AddTodo(props) {
    return (
        <>
            ...
            <button className=" rounded bg-transparent border-none focus:outline-none col-start-9 col-span-1 row-start-5 row-end-5 p-2"><BsExclamationTriangle className="text-red-600" size={25} /></button>
            <button className=" rounded border-none bg-transparent focus:outline-none bg-black col-start-10 border col-span-1 row-start-5 row-end-5 p-2"><IoIosStarOutline className="text-yellow-400" size={25}/></button>
