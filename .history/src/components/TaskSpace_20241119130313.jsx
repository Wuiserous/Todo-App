...
const sortedCards = [...cards].sort((a, b) => {
    ...
    if (priorityComparison !== 0) {
        return priorityComparison; // Sort by priority
    }
    return a.deadLineSeconds - b.deadLineSeconds; // Sort by deadline if priority is the same
});

// Render the sorted list or log it
