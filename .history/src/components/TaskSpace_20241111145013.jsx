    ...
    return (
      ...
      `}</style>
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          ...
          <div className=" p-2 text-left h-[50px] overflow-auto hide-scrollbar"><p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur id molestiae ab nulla accusamus natus voluptatum repellendus! Nam asperiores corporis eum id eaque corrupti numquam ex dolorem architecto voluptates!
