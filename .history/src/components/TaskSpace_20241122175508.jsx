...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 transition-transform duration-300 ease-in-out ${props.isExpanded? 'col-span-3': 'transform scale-x-25'} hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
