...
export default function LinkModal(props) {
    ...
    if (props.children == 0) return (
        ...
        onClick={hide}>
            <div className={`fixed top-60 left-[480px] p-2 h-fit backdrop-blur-sm bg-white/5 transform transition-all duration-100 text-black overflow-auto rounded ${isVisible ? "scale-100 opacity-100" : "scale-50 opacity-0"}`}>
