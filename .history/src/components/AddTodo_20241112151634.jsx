        ...
        <>
            ...
            {showTask && (
                <div className="grid auto-rows-auto gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
                    ...
                    <button className="rounded border-none bg-white focus:outline-none bg-black col-start-10 border col-span-1 row-start-12 row-end-13 p-2" onClick={toggleUrgent}>
                        <IoIosStarOutline className="text-black" size={25} />
                    </button>
                    {props.submitButton}
                    <button className="col-start-8 col-span-1 row-start-12 row-end-13 bg-white p-2 rounded" onClick={toggleImportant}>
