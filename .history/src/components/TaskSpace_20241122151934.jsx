...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
      <div className="absolute w-fit h-full right-0 z-10 flex justify-center items-center"><button className=" h-20 w-5 bg-white/25 bacldropblur-sm p-1 rounded rounded-tr-[0px] rounded-br-[0px]"><FaAngleRight /></button></div>
