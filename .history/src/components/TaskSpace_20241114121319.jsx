    ...
    <div className={`rounded-xl grid grid-cols-3 gap-2 p-2 hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 ${props.bgColor}`}>
      <div className="h-full flex flex-col gap-2 col-span-1">
        {columns[0].map((card, index) => (
          <div className={`w-full relative h-fit border-[1px] border-[#333333] bg-[#1E1E1E] hover:shadow-[0_0_15px_5px_rgba(187,134,252,0.5)] hover:border-white  flex flex-col gap-2 p-4 rounded-tl-xl rounded-tr-xl rounded-bl-xl card-animation transition-all duration-300`} key={index}>  
            {index*3 === props.hoveredCardIndex ? (<div className='w-full h-full inset-0 absolute rounded-tl-xl rounded-tr-xl rounded-bl-xl shadow-[0_0_15px_5px_rgba(187,134,252,0.5)]'></div>) : (null)} 
            ...
            <button onClick={() => props.deleteCard(index*3 + 0)}><MdOutlineDelete /></button>
      ...
      <div className="h-full flex flex-col gap-2 col-span-1">
        {columns[1].map((card, index) => (
          <div className={`w-full relative h-fit border-[1px] border-[#333333] bg-[#1E1E1E] hover:shadow-[0_0_15px_5px_rgba(187,134,252,0.5)] hover:border-white flex flex-col gap-2 p-4 rounded-tl-xl rounded-tr-xl rounded-bl-xl card-animation transition-all duration-300`} key={index}>
            {index*3 + 1 === props.hoveredCardIndex ? (<div className='w-full h-full inset-0 absolute z-0 rounded-tl-xl rounded-tr-xl rounded-bl-xl shadow-[0_0_15px_5px_rgba(187,134,252,0.5)]'></div>) : (null)}
            <h3 className="text-[#A0A0A0]">{card.title}</h3>
            <p className="text-[#E0E0E0]">{card.description}</p>
            <p>Priority: 
              {card.isUrgent && card.isImportant ? 'Urgent and Important' : 
            ...
            <button onClick={() => props.deleteCard(index*3 + 1)}><MdOutlineDelete /></button>
            {card.isUrgent && card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#D32F2F] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isUrgent ? (<div className="w-10 h-5 absolute z-10 bg-[#FF5722] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#FF9800] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : (
                <div className="w-10 h-5 absolute z-10 bg-[#03A9F4] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>
      ...
      <div className="h-full flex flex-col gap-2 col-span-1">
        {columns[2].map((card, index) => (
          <div className={`w-full relative h-fit border-[1px] border-[#333333] bg-[#1E1E1E] hover:shadow-[0_0_15px_5px_rgba(187,134,252,0.5)] flex flex-col gap-2 p-4 rounded-tl-xl rounded-tr-xl rounded-bl-xl card-animation transition-all duration-300`} key={index}>
            {index*3 + 2 === props.hoveredCardIndex ? (<div className='w-full h-full inset-0 absolute rounded-tl-xl rounded-tr-xl rounded-bl-xl shadow-[0_0_15px_5px_rgba(187,134,252,0.5)]'></div>) : (null)}
            <h3 className="text-[#A0A0A0]">{card.title}</h3>
            <p className="text-[#E0E0E0]">{card.description}</p>
            <p>Priority: 
              {card.isUrgent && card.isImportant ? 'Urgent and Important' : 
            ...
            <button onClick={() => props.deleteCard(index*3 + 2)}><MdOutlineDelete /></button>
            {card.isUrgent && card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#D32F2F] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isUrgent ? (<div className="w-10 h-5 absolute z-10 bg-[#FF5722] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#FF9800] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : (
                <div className="w-10 h-5 absolute z-10 bg-[#03A9F4] bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>
