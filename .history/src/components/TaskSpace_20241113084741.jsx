        ...
        {columns[1].map((card, index) => (
          <div className={`w-full relative h-fit border-[1px] border-[#333333] ${index*3 + 1 === props.hoveredCardIndex ? 'bg-green-500' : ''} flex flex-col gap-2 p-4 rounded-tl-xl rounded-tr-xl rounded-bl-xl card-animation transition-all duration-300`} key={index}>
            ...
            {card.isUrgent && card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#D32F2F] border-t border-gray-500 bottom-[-20px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isUrgent ? (<div className="w-10 h-5 absolute z-10 bg-[#FF5722] border-t border-gray-500 bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : 
              card.isImportant ? (<div className="w-10 h-5 absolute z-10 bg-[#FF9800] border-t border-gray-500 bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>) : (
                <div className="w-10 h-5 absolute z-10 bg-[#03A9F4] border-t border-gray-500 bottom-[-21px] rounded-bl-lg rounded-br-xl right-[-1px]"></div>
              )}
          </div>
        ))}
      </div>
