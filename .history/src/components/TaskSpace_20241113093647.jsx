...
export default function TaskSpace(props) {
  ...
  if (cards.length == 0) return <div className={`rounded-xl grid grid-cols-3 gap-2 p-2 hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 ${props.bgColor}`}>
