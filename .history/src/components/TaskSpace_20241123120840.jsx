...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 transition-all duration-300 ease-in-out transform  hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
      style={{
    gridColumn: props.isExpanded ? 'span 3 / span 3' : 'span 1 / span 1',
  }}
      <div className="absolute w-[25px] h-20 top-[40%] right-0 overflow-auto group hide-scrollbar z-10 flex justify-center items-center">{props.expandButton}</div>
