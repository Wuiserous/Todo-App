...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 col-end-3 hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
      <div className="absolute w-fit h-full right-0 overflow-auto group hide-scrollbar z-10 p-5 pr-[0px] flex justify-center items-center"><button className="absolute right-[-12px] transform duration-300 hover:right-0 h-20 w-5 border focus:border-none bg-white/25  p-1 rounded rounded-tr-[0px] rounded-br-[0px]"><FaAngleRight /></button></div>
