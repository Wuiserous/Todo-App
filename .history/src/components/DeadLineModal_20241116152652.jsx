    ...
    return (
        ...
        onClick={hide}>
            ...
            <div className=" flex flex-wrap gap-2 justify-center items-center">
                {props.children}
                {day && time ? (
                    <div className="w-fit h-fit p-2 rounded-lg bg-orange-500 justify-center items-center flex flex-row gap-1">
                        <span>{day}</span>
                        <span>{month}</span>
                        <span>{year}</span>
                        <span>{time}</span>
                    ...
                    <div className="w-fit h-fit p-2 rounded-lg text-white justify-center items-center flex flex-row gap-1">
