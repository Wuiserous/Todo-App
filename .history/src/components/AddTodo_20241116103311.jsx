        ...
        <>
            ...
            {showTask && (
                <div className="grid auto-rows-auto gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
                    <div className="row-span-1 col-span-10 border flex flex-row justify-center items-center rounded bg-[#ffffff] pr-1">
                        {props.titleInput}
                        <div className="w-fit h-fit bg-orange-500 rounded-lg flex flex-row gap-1 p-1 rounded-br-[0px]"><span>17</span><span>nov</span><span>10:30</span></div>
                    </div>
