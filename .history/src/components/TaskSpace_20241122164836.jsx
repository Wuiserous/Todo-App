...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 ${props.isExpanded? 'col-end-5': 'col-end-3'} transform duration-300 hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
        ...
        {columns[0].map((card, index) => (
          <div className={`w-full relative h-fit border-[1px] border-[#333333] bg-[#1E1E1E] hover:shadow-[0_0_15px_5px_rgba(187,134,252,0.5)]  flex flex-col gap-2 p-4 rounded-[5px] rounded-br-[0px] rounded-bl-[0px] card-animation transition-all duration-300 group`} key={index}>  
            ...
            {card.isUrgent && card.isImportant ? (
              ...
              <div className="w-full h-[5px] absolute z-10 bottom-[0px] left-[0.1px] text-center text-[12px]">
              ...
              <div className="w-full h-[5px] absolute z-10 bg-[#ffff00] bottom-[0px] left-[0.1px] text-center text-[12px]"></div>
