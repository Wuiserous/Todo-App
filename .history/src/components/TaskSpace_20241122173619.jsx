...
export default function TaskSpace(props) {
  ...
  return (
    <div className={`rounded-xl relative col-start-2 transition-all duration-1000 ${props.isExpanded? 'col-end-5': 'col-end-3'} hide-scrollbar row-start-2 row-end-5 ${props.bgColor}`}>
