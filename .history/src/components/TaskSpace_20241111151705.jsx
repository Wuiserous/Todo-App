      ...
      <div className={`rounded-xl flex p-2 gap-4 flex-wrap hide-scrollbar overflow-auto col-start-2 row-start-2 row-end-5 border ${props.bgColor} border-gray-500`}>
        <div className="min-w-[200px] max-w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          ...
          <div className="text-left h-[150px] w-fit overflow-auto hide-scrollbar">
            ...
            Natus exercitationem repellat commodi! Ad praesentium eaque labore quam, ipsam molestiae assumenda veniam consequuntur doloremque dolorum neque, obcaecati incidunt eveniet id quaerat voluptates voluptatem quia. Officia unde soluta vel impedit.</p>
          </div>
        </div>
      </div>
    )
