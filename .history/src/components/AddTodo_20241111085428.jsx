...
export default function AddTodo(props) {
    return (
        <>
            ...
            <button className=" rounded bg-white border-none focus:outline-none col-start-9 col-span-1 row-start-5 row-end-5 p-2"><BsExclamationTriangle className="text-red-600" size={25} /></button>
