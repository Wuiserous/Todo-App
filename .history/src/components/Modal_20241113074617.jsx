...
export default function Modal(props) {
    ...
    return (
      <div
        className="fixed z-11 inset-0 bg-black bg-opacity-45"
        id="wrapper"
        onClick={hide}
      >
        <div
          className={`relative w-[500px] top-20 left-20 h-fit ${props.bgColor} rounded-xl transform transition-all duration-300 p-2 ${
