    ...
    return (
        <>
            <div className="col-start-1 col-end-11 border grid grid-cols-[1fr_1fr] grid-rows-[1fr]">
                <button className="col-start-1 border p-2 col-span-1" onClick={handleTask}>Task</button>
                <button className="col-start-2 p-2 col-span-1 border" onClick={handleTodo}>Todo</button>
            </div>
            if(showTask)
            ...
            <div className="grid grid-rows-[1fr_40px_40px_1fr] gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">todo</div>
        </>
