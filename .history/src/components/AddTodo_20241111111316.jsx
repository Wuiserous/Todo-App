        ...
        <>
            ...
            {showTask && (
                <div className="grid auto-rows-auto gap-2 grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
                    ...
                    <button className="col-start-1 col-span-7 row-start-12 row-end-13 hover:bg-blue-600 transform transition-all duration-300 bg-blue-500 p-2 rounded">Add</button>
