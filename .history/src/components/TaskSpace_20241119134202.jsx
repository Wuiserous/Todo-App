...
export default function TaskSpace(props) {
  ...
  cards.forEach((card) => {
    ...
    else if (card.priority === 'P4') {
      Priority4.push(card)
    }
  })

  const sortedPriority1 = Priority1.sort((a, b) => a.secondsLeft - b.secondsLeft)
  const sortedPriority2 = Priority1.sort((a, b) => a.secondsLeft - b.secondsLeft)
  const sortedPriority3 = Priority1.sort((a, b) => a.secondsLeft - b.secondsLeft)
  const sortedPriority4 = Priority1.sort((a, b) => a.secondsLeft - b.secondsLeft)
