    ...
    return (
      ...
      `}</style>
        <div className="w-[200px] border rounded-lg h-fit flex flex-col gap-2 p-2">
          ...
          <div className=" p-2 text-left h-"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit possimus debitis dolorem assumenda provident, numquam sit quas minima vitae cumque est commodi, exercitationem quam dicta? Necessitatibus hic consequuntur facilis veritatis?</p></div>
        </div>
      </div>
    )
}