...
export default function AddTodo(props) {
    return (
        <>
            ...
            <button className="col-start-1 col-span-6 row-start-5 bg-blue-500 p-2 rounded">Add</button>
            <button className="col-start-7 col-span-2 row-start-5 bg-blue-500 p-2 rounded">Add</button>
        </>
