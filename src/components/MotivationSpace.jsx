export default function MotivationSpace(props) {
  ...
  return (
    <div className={`rounded-xl scroll-smooth overflow-auto hide-scrollbar row-start-2 row-end-5 p-2 col-start-4 col-end-4 col-span-3 ${props.bgColor} flex items-center flex-col gap-2`}>
      <div className="w-full h-12 rounded-xl bg-[#1E1E1E] p-2">Keep it up!👍</div>
      <div className="w-full h-12 rounded-xl bg-[#1E1E1E] p-2">Keep it up!👍</div>
      <div className="w-full h-12 rounded-xl bg-[#1E1E1E] p-2">Keep it up!👍</div>
      <div className="w-full h-12 rounded-xl bg-[#1E1E1E] p-2">Keep it up!👍</div>
      <div className="w-full h-12 rounded-xl bg-[#1E1E1E] p-2">Keep it up!👍</div>
